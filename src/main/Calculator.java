...
public class Calculator {
	...
	public static final double at = 0.0 * Math.PI;
	...
	public void iteration() {
		double[] k1 = LLG_w(teta, fi, t);
		double[] k2 = LLG_w(teta + k1[0] * dt/2, fi + k1[1] * dt/2, t + dt/2);
		double[] k3 = LLG_w(teta + k2[0] * dt/2, fi + k2[1] * dt/2, t + dt/2);
		double[] k4 = LLG_w(teta + k3[0] * dt, fi + k3[1] * dt, t + dt);	
